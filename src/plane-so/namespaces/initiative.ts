...
export class PlaneSoInitiativeClient {
  ...
  public async getV1Labels(): Promise<ResponseArray<V1Entity>> {
    return this.client.getPaginatedList(`v1/workspaces/${this.client.workspace.id}/initiatives/${this.initiativeId}/labels/`, V1EntitySchema);
  }

  public async getV1Projects(): Promise<ResponseArray<V1Project>> {
    return this.client.getPaginatedList(`v1/workspaces/${this.client.workspace.id}/initiatives/${this.initiativeId}/projects/`, V1ProjectSchema);
  }

  public async getV1Epics(): Promise<ResponseArray<V1Entity>> {
    return this.client.getPaginatedList(`v1/workspaces/${this.client.workspace.id}/initiatives/${this.initiativeId}/epics/`, V1EntitySchema);
  }
}
