...
export class PlaneSoTeamspaceClient {
  ...
  public async getV1Members(): Promise<ResponseArray<V1Entity>> {
    return this.client.getPaginatedList(`v1/workspaces/${this.client.workspace.id}/teamspaces/${this.teamspaceId}/members/`, V1EntitySchema);
  }

  public async getV1Projects(): Promise<ResponseArray<V1Project>> {
    return this.client.getPaginatedList(`v1/workspaces/${this.client.workspace.id}/teamspaces/${this.teamspaceId}/projects/`, V1ProjectSchema);
  }
}
